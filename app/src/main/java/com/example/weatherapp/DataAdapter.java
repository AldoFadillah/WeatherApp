...
public class DataAdapter {
    ...
    private com.example.weatherapp.DatabaseHelper mDbHelper;
    ...
    public DataAdapter(Context context)
    {
        ...
        mDbHelper = new com.example.weatherapp.DatabaseHelper(mContext);
    }
    ...
    public com.example.weatherapp.DataAdapter createDatabase() throws SQLException
    {
        try
        {
    ...
    public com.example.weatherapp.DataAdapter open() throws SQLException
    {
        try
        {
